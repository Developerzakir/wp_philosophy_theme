                ...
                <div class="featured">
                        ...
                        <div class="entry"
                         style="background-image:url('<?php echo esc_url($post_data[0]['thumbnail']) ?>');">
                            ...
                            <div class="entry__content">
                                ...
                                <?php echo esc_html($post_data[0]['category']) ?>
                                </a></span>
                                ...
                                <div class="entry__info">
                                    <a href="#0" class="entry__profile-pic">
                                        <img class="avatar" 
                                        src="<?php echo esc_url($post_data[0]['author_avatar']) ?>" alt="">
                                    </a>
                    ...
                    <div class="entry"
                         style="background-image:url('<?php echo esc_url($post_data[$i]['thumbnail']) ?>');">
                            ...
                            <div class="entry__content">
                                <span class="entry__category"><a href="#0">
                                <?php echo esc_html($post_data[$i]['category']) ?>
                                </a></span>
                                ...
                                <div class="entry__info">
                                    <a href="#0" class="entry__profile-pic">
                                        <img class="avatar" 
                                        src="<?php echo esc_url($post_data[$i]['author_avatar']) ?>" alt="">
                                    </a>
